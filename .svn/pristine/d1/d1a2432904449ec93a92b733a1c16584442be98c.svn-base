...
function initSub(){
	...
	[
		...
		{name:"description",index:"description"	, sortable:false,		formatter:"string",		width:95,	align:"left",	editable:true},
		{name:"asset_num",	index:"asset_num"	, sortable:false,		formatter:"string",		width:95,	align:"left",	editable:true},
		{name:"quantity",	index:"quantity"	, sortable:false,		formatter:"string",		width:95,	align:"left",	editable:true},
		{name:"return_sel",	index:"return_sel"	, sortable:false,		formatter: "select",	width:95,	align:'center',	editable:true,	edittype:'select', 
			editoptions:{value:getComboValue('return_sel'), dataInit: function(elem) {$(elem).width(95);}
		        },
		        editrules:{required:true}
		},
		{name:"day1",		index:"day1"		, sortable:false,		formatter:"string",		width:94,	align:"center",	editable:true,	frozen : false,
			editoptions: {
				readonly : true,
		...
		{name:"day2",		index:"day2"		, sortable:false,		formatter:"string",		width:94,	align:"center",	editable:true,	frozen : false,
			editoptions: {
				readonly : true,
	            dataInit: function(element) {
	     		    $(element).datepicker({
