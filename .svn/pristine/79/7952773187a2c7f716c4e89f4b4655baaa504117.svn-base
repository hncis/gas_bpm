...
function fnSetDocumentReady(){
	$(".sub_title").hide();
//	getCommonCode("budg_no:XBT:S;budg_wbs:XBT;", "N", "", "/hncis/system/getPurchaseOrderCombo.do");
//	getCommonCode("budg_type:X3012;", "N", "setComboInfo();");
	setComboInfo();
}
...
//	var paramValue    = "dom_abrd_scn_cd:place_type:S;budg_no:X0022:S;";
...
function init(){
	...
	cn = ["Doc No.", "SEQ", "PGS_ST_CD", "사번", "이름", "DepartmentCode", "부서", "직급", "Visa", "Cost<BR>Center", "항공티켓", "숙박", "렌트카", "비자","BTR<BR>FORECAST", "진행상태", "Cost Info"];
	cm = [
			...
			{name:"eeno",		index:"eeno"		, sortable:false,	formatter:"string",		width:150,	align:"left",	editable:false,	frozen : false},
			{name:"ee_nm",		index:"ee_nm"		, sortable:false,	formatter:"string",		width:150,	align:"left",	editable:false,	frozen : false},
			...
			{name:'visa_yn',	index:'visa_yn'		, sortable:false,	formatter:"select",		width:55, 	align:"center",	editable:false, 	edittype:'select', hidden : true,
			...
			{name:"pgs_st_nm",	index:"pgs_st_nm"	, sortable:false,	formatter:"string",		width:150,	align:"center",	editable:false,	frozen : false},
			{name:"cost_info",	index:"cost_info"	, sortable:false,	formatter:"string",		width:340,	align:"center",	editable:false,	frozen : false, hidden: true}
		];
	...
	flight_cm = [
			...
			{name:"flt_air_lines"		, index:"flt_air_lines"		, sortable:false,	formatter:"string",		width:246,	align:"left",	editable:true,	frozen : false},
			...
			{name:"flt_seat"			, index:"flt_seat"			, sortable:false,	formatter:"string",		width:100,	align:"left",	editable:true,	frozen : false, hidden:true},
	...
	rent_cn = ["", "", "체크인","체크아웃","회사","차종","차량명","연락처","지불양식","비고","금액"];
	rent_cm = [
	...
	cn_vt = ["Doc No.", "SEQ", "PGS_ST_CD", "ID No.", "Name", "DepartmentCode", "Department", "Position", "Visa", "Cost<BR>Center", "Air Ticket", "Hotel", "Rent a car", "Visa","BTR<BR>FORECAST", "STATUS", "Cost Info"];
	cm_vt = [
			...
			{name:"vt_pgs_st_cd",	index:"vt_pgs_st_cd"	, sortable:false,	formatter:"string",		width:0,	align:"left",	editable:true,	frozen : false, hidden : true},
			{name:"vt_eeno",		index:"vt_eeno"		, sortable:false,	formatter:"string",		width:80,	align:"left",	editable:false,	frozen : false
			},
			{name:"vt_ee_nm",		index:"vt_ee_nm"		, sortable:false,	formatter:"string",		width:142,	align:"left",	editable:false,	frozen : false},
			...
			{name:"vt_ops_nm",		index:"vops_nm"		, sortable:false,	formatter:"string",		width:160,	align:"left",	editable:false,	frozen : false},
			{name:"vt_poa_nm",		index:"vt_poa_nm"		, sortable:false,	formatter:"string",		width:150,	align:"left",	editable:false,	frozen : false},
			{name:'vt_svisa_yn',	index:'vt_visa_yn'		, sortable:false,	formatter:"select",		width:55, 	align:"center",	editable:false, 	edittype:'select',
				editoptions:{value:"Y:Y;N:N"
		    	,dataInit: function(elem) {
	        	$(elem).width(65);
	    		}}
			},
			{name:"vt_cost_cd",	index:"vt_cost_cd"		, sortable:false,	formatter:"string",		width:80,	align:"center",	editable:false,	frozen : false, editoptions:{maxlength:"8"}},
			{name:"vt_flht_utz_amt",	index:"vt_flht_utz_amt"	, sortable:false,formatter: 'currency', formatoptions: {
			    decimalSeparator:",",
			    thousandsSeparator:".",
			    decimalPlaces:2,
			    defaultValue:""
			  ...
			  {name:"vt_bztp_lodg_exp",	index:"vt_bztp_lodg_exp"	, sortable:false,formatter: 'currency', formatoptions: {
				    decimalSeparator:",",
				    thousandsSeparator:".",
				    decimalPlaces:2,
				    defaultValue:""
			  ...
			  {name:"vt_rent_amt",	index:"vt_rent_amt"	, sortable:false,formatter: 'currency', formatoptions: {
				    decimalSeparator:",",
				    thousandsSeparator:".",
				    decimalPlaces:2,
				    defaultValue:""
			  ...
			  {name:"vt_vs_ptt_exp",	index:"vt_vs_ptt_exp"	, sortable:false,formatter: 'currency', formatoptions: {
				    decimalSeparator:",",
				    thousandsSeparator:".",
				    decimalPlaces:2,
				    defaultValue:""
			  ...
			  {name:"vt_etc_amt",	index:"vt_etc_amt"	, sortable:false,formatter: 'currency', formatoptions: {
				    decimalSeparator:",",
				    thousandsSeparator:".",
				    decimalPlaces:2,
				    defaultValue:""
			...
			{name:"vt_pgs_st_nm",	index:"vt_pgs_st_nm"	, sortable:false,	formatter:"string",		width:65,	align:"center",	editable:false,	frozen : false, hidden : true},

			{name:"vt_cost_info",	index:"vt_cost_info"	, sortable:false,	formatter:"string",		width:0,	align:"center",	editable:false,	frozen : false, hidden : true}
		];
	...
	vt_gridParam = {
		viewEdit : [{
			...
			cellEdit     : true,
			fnMerge      : false,
			completeFc   : "addGridRow(3, '"+gridName6+"', 'vt_datarow');",
			paramJson    : ""
		}]
	};
	...
	jQuery("#"+gridName1).jqGrid('setLabel', 'visa_yn', '<td class="tooltip" title="Check if the<br>traveler has VISA." onmouseover="tooltipDisplay(\'tooltip\');" align="center" width="35" style="font-weight:bold">비자</td>');
	...
	jQuery("#"+gridName1).jqGrid('setLabel', 'vs_ptt_exp', '<td align="center" width="100" style="font-weight:bold">비용</td>');
	jQuery("#"+gridName1).jqGrid('setLabel', 'etc_amt', '<td align="center" width="100" style="font-weight:bold">회사카드</td>');
