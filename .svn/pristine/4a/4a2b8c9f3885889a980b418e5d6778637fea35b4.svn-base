...
var cn = ["회사", "사진작가", "상표", "모델", "시리얼 #", "일", "시간", "일", "시간",
...
var datarow = {company:"", photographer:"", brand:"", model:"", serial:"", day1:"", hour1:"",day2:"", hour2:"",
			   seq: "", eeno: "", apply_date: "", if_id: "", pgs_st_nm: "", pgs_st_cd: "", purpose:"", area:"", exposure:"", reason:"", remark:"", doc_no:"", snb_rson_sbc:""};
var cm =
[
	{name:"company",	index:"company"		, sortable:false,		formatter:"string",		width:100,	align:"left",	editable:true},
	{name:"photographer",index:"photographer", sortable:false,		formatter:"string",		width:100,	align:"left",	editable:true},
	{name:"brand",		index:"brand"		, sortable:false,		formatter:"string",		width:160,	align:"left",	editable:true},
	{name:"model",		index:"model"		, sortable:false,		formatter:"string",		width:100,	align:"left",	editable:true},
	{name:"serial",		index:"serial"		, sortable:false,		formatter:"string",		width:100,	align:"left",	editable:true},
	{name:"day1",		index:"day1"		, sortable:false,		formatter:"string",		width:100,	align:"center",	editable:true,	frozen : false,
		editoptions: {
			readonly : true,
	 ...
	 {name:"hour1",		index:"hour1"		, sortable:false,	formatter:"string",		width:100,	align:"center",	editable:true,	frozen : false,
	...
	{name:"day2",		index:"day2"		, sortable:false,		formatter:"string",		width:100,	align:"center",	editable:true,	frozen : false,
		editoptions: {
			readonly : true,
            dataInit: function(element) {
     		    $(element).datepicker({
	...
	{name:"hour2",		index:"hour2"		, sortable:false,	formatter:"string",		width:100,	align:"center",	editable:true,	frozen : false,
		editoptions: {maxlength:"4",
            dataInit: function(element) {
     		    $(element).keyup(function(){
...
function doCudAction(gubun) {
		...
		for(var i = 0; i < ids.length; i++){
			...
			if(rowId){
				if(getColValue("company", rowId) != "" && getColValue("photographer", rowId) != ""){
					...
					if(st_dt > end_dt){
						parent.alertUI(rowId + " 줄 : 시작일은 종료일보다 클 수 없습니다.");
						return false;
					}
	...
	if(params.length == 0){
		parent.alertUI("회사, 사진작가, 상표를 입력하세요.");
		return;
	}
...
function fnCopy(gubun) {
	...
	var url = "doInsertSecurityRequestFilmCopy.do";
	var callBack = "actionCallBack(jsonData.sendResult);";
	var params = [];
	var ids = jQuery("#"+gridName1).getDataIDs();
