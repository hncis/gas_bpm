...
<script>
	...
	$(document).ready(function() {
		...
		$("#workItemHandlerA").click(function(){
		});
...
<body>
	...
	<div class="container-fluid">
		<div id="tabs">
			<ul>
				<li><a id="workItemHandlerA" href="#workItemHandlerDiv"><spring:message 	code="process.procvars.label" /></a></li>
				<li><a id="flowchartA" href="#flowchartDiv"><spring:message 	code="process.flowchart.label" /></a></li>
			</ul>
			<div id="workItemHandlerDiv">
				<iframe frameborder="0" id="workItemHandlerFrame" name="workItemHandlerFrame" style="width:100%; overflow-x: hidden;"></iframe>
			</div>
			<div id="flowchartDiv">
