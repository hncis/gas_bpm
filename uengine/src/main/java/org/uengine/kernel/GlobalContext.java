...
public class GlobalContext{
	...
	public final static String LOGIN_SESSION_ATTR_NAME = GlobalContext.getPropertyString("login.session.attr.name", "loggedUser");
	public final static String PORTRAIT_PATH = GlobalContext.getPropertyString("portrait.path", "/images/portraits/");
	public final static String DEFAULT_PORTRAIT_FILE_NAME = GlobalContext.getPropertyString("default.portrait.filename", "no_image.gif");
	public final static String[] PORTRAIT_EXTENTIONS = GlobalContext.getPropertyString("portrait.extentions", "gif,png,jpg").split(",");
	...
	public static String WEB_CONTEXT_ROOT = GlobalContext.getPropertyString("web.context.root", "/bpm");
	...
	public final static boolean logLevelIsDebug = "true".equals(GlobalContext.getPropertyString("log.level.debug", "true"));
...
*/
	...
	public static final String getLocalizedMessage(String key, String defaultValue) {
		try{
			Locale locale = new Locale(getPropertyString("default.locale", Locale.getDefault().getLanguage()));
			if(messages==null)
