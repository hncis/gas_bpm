...
//			wlDAO.setTaskId(new Long(taskId));
			...
			if(userId!=null) {
				...
				wlDAO.setResName(rm.getResourceName());
			}
			...
			if ( parameters != null ) {
				for(int i=0; i<parameters.length; i++){
	                ...
	                }else if("extValue1".equals(parameter.getKey())){
						wlDAO.set("EXT1", parameter.getValue());
					}else if("extValue2".equals(parameter.getKey())){
						wlDAO.set("EXT2", parameter.getValue());
					}else if("extValue3".equals(parameter.getKey())){
						wlDAO.set("EXT3", parameter.getValue());
					}else if("extValue4".equals(parameter.getKey())){
						wlDAO.set("EXT4", parameter.getValue());
					}else if("extValue5".equals(parameter.getKey())){
						wlDAO.set("EXT5", parameter.getValue());
					}else if("extValue6".equals(parameter.getKey())){
						wlDAO.set("EXT6", parameter.getValue());
					}else if("extValue7".equals(parameter.getKey())){
						wlDAO.set("EXT7", parameter.getValue());
					}else if("extValue8".equals(parameter.getKey())){
						wlDAO.set("EXT8", parameter.getValue());
					}else if("extValue9".equals(parameter.getKey())){
						wlDAO.set("EXT9", parameter.getValue());
					}else if("extValue10".equals(parameter.getKey())){
						wlDAO.set("EXT10", parameter.getValue());
					}
				}
			}
