	...
	*/
	...
	public static void testFormat ()
	{
		...
		if (logger.isInfoEnabled()) {
			logger.info("testFormat() - " + buffer); //$NON-NLS-1$
		}
		if (logger.isInfoEnabled()) {
			logger
					.info("testFormat() - formatStr total iteration[" + total + "]  " + (end - start) + "ms."); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
		...
		if (logger.isInfoEnabled()) {
			logger
					.info("testFormat() - format total iteration[" + total + "]  " + (end - start) + "ms."); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
		...
		if (logger.isInfoEnabled()) {
			logger.info("testFormat() - " + formatMessage(values, lens, "")); //$NON-NLS-1$ //$NON-NLS-2$
		}
		int[] lens2 = new int[] { 1 , 3 , 19 , 9 , 5, 10 };
		

		if (logger.isInfoEnabled()) {
			logger.info("testFormat() - " + formatMessage(values, lens2, " ")); //$NON-NLS-1$ //$NON-NLS-2$
		}
		if (logger.isInfoEnabled()) {
			logger
					.info("testFormat() - formatMessage total iteration[" + total + "]  " + (end - start) + "ms."); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		}
