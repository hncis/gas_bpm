...
public class UpdateListFilterList {
	...
	public final static String FILE_PATH = FILE_SYSTEM_DIR + "updatelist\\"+"updateListFilters.xml";
	...
	public UpdateListFilterList(){
		this.workItemFilters = new HashMap();
	}
	
	public static void save(UpdateListFilterList updateListFilterList)throws UEngineException{
		try {
			File dirToCreate = new File(FILE_SYSTEM_DIR + "updatelist");
			dirToCreate.mkdirs();
			...
			GlobalContext.serialize(updateListFilterList, bao, String.class);
	...
	public static UpdateListFilterList load()throws UEngineException{
		try {
