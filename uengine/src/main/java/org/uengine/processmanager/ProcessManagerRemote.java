...
public interface ProcessManagerRemote extends javax.ejb.EJBObject{
	...
	public String addProcessDefinitionWithProgramId(String name, int version, String description, boolean isAdhoc, String strDef, String folder, String belongingPdid, String alias, String objectType, String programId, String author, String duration) throws RemoteException;
	...
	public String addFolder(String folderName, String parentFolder, String comCode) throws RemoteException;
