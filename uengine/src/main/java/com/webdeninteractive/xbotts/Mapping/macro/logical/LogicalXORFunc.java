 ...
 * @author  bmadigan, jdu
 */
public class LogicalXORFunc extends AbstractExtensionFunction {
    
    /** Creates a new instance of LogicalXORFunc 
	 * with the left link parameter boolean1 and boolean2.
	 */
    public LogicalXORFunc() {
	     super.addLinkableParameter("boolean1"); 
		 super.addLinkableParameter("boolean2"); 
    }
    
   
  /** logicalXOR function for nodelist.
   ...
   */ 
    public org.w3c.dom.NodeList logicalXOR(org.w3c.dom.NodeList list1, org.w3c.dom.NodeList list2)throws Exception{
        Element elem=null;
        Document owner= null;
        if(list1.getLength( )!=list2.getLength( )) throw new Exception("Attempted to logicalXOR NodeList of unequal lengths");
