 ...
 * @author  bmadigan, jdu
 */
public class LogicalOrFunc extends AbstractExtensionFunction {
    
    /** Creates a new instance of LogicalOrFunc
	 * with the left link parameter boolean1 and boolean2.
	 */
    public LogicalOrFunc() {
	     super.addLinkableParameter("boolean1"); 
		 super.addLinkableParameter("boolean2"); 
    }
    
       
  /** logicalOr function for nodelist.
   ...
   */ 
    public org.w3c.dom.NodeList logicalOr(org.w3c.dom.NodeList list1, org.w3c.dom.NodeList list2)throws Exception{
        Element elem=null;
        Document owner= null;
        if(list1.getLength( )!=list2.getLength( )) throw new Exception("Attempted to logicalOr NodeList of unequal lengths");
