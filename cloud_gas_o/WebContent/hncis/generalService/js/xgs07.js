...
function ProdutoMultiCombo1(){
	getCommonCode("seqc_1::Z:S1;", "Y", "doComboCallback1(jsonData.sendResult);", "/hncis/generalService/getCatgCombo.do");
}
...
function ProdutoMultiCombo2(){
	getCommonCode("seqc_2::Z:S2;", "Y", "doComboCallback2(jsonData.sendResult);", "/hncis/generalService/getCatgCombo.do");
}
...
function ProdutoMultiCombo3(){
	getCommonCode("seqc_3::Z:S3;", "Y", "doComboCallback3(jsonData.sendResult);", "/hncis/generalService/getCatgCombo.do");
}
...
function doSearch(){
	doCommonSearch("doSearchByXgs02.do", util.jsonToString(fnParamJson()), "loadCallBack();", gridName, "N");
}
	...
	$("#pop_yes").click(function(){
		$.unblockUI({
			onUnblock: function(){
				...
				doCommonAjax("doInsertByXgs07Request.do", paramData, "insertCallBack(jsonData.sendResult);");
			}
		});
	});
}
	...
	$("#pop_yes").click(function(){
		$.unblockUI({
			onUnblock: function(){
				...
				doCommonAjax("doUpdateByXgs07Request.do", paramData, "doSearch();");
			}
		});
	});
}
	...
	$("#pop_yes").click(function(){
		$.unblockUI({
			onUnblock: function(){
				...
				doCommonAjax("doUpdateByXgs07RequestCancel.do", paramData, "doSearch();");
			}
		});
	});
}
