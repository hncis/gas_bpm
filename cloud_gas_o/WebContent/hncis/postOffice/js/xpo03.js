var excelCn = ["Apply Date", "Status", "Name", "Position", "Dept.", "Cost Center", "Tracking No.", "Service Description", "Number of Objects", "Additional Services", "Company Name", "Zip Code", "Return Reason"];
var excelCm = ["ptt_ymd", "pgs_st_nm", "req_eeno_nm", "req_step_nm", "req_dept_nm", "cost_cd", "po_trk_no", "po_serv_desc", "po_numb_obj", "po_addt_serv", "po_comp_nm", "po_zip_cd", "snb_rson_sbc"];
...
function init(){
	...
	gridParam = {
		viewEdit : [{
			gridName     : gridName,
			url          : "doSearchGridPoToConfirm.do",
...
function doSearch(msgFlag){
	...
	doCommonSearch("doSearchGridPoToConfirm.do", util.jsonToString(params), "loadCallBack();initAfterMenus();", gridName, msgFlag);
}
...
function doExcel(){
	...
	gridToExcel("#"+gridName, "doExcelToConfirm.excel", params);
}
