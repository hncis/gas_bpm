		...
		$("#pop_yes").click(function(){
			$.unblockUI({
				onUnblock: function(){
					...
					doCommonAjax("doDeletePoToFile.do", paramData, "deleteCallBack(jsonData.sendResult);");
				}
			});
		});
	}
...
function doSearch(){
	...
	doCommonSearch("doSearchPoToFile.do", util.jsonToString(params), "searchCallBack();", gridName1);
}