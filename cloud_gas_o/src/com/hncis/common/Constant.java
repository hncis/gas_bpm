package com.hncis.common;

public class Constant {

	public static String pageSize = "30";												// 페이징 한페이지의 글의 개수
	public static String pageSizePopUp = "10";											// 팝업 한페이지의 글의 개수
	public static String pageSizeSystem = "10";											// 팝업 한페이지의 글의 개수
	public static String pageSizeSystemBackground = "6";								// 시스템 - background 한페이지의 글의 개수

	public static final String SESSION_USER_INFO  = "USER_INFO";						// 세션 사용자 정보
	public static final String SESSION_USER_KEY  = "USER_KEY";							// 세션정보 키
	//public static final int SESSION_INTERVAL_TIME  = 60;								// 세션정보 키
	public static final int SESSION_INTERVAL_TIME  = 120*60;							// 세션정보 키
	...
	public static final String APACHE_LOG_TEST_PATH = "D:/Apache2.2/logs";		// apache local path
	public static final String APACHE_LOG_REAL_PATH = "D:/Apache2.2/logs";		// apache local path

	public static final String SCR_KEY = "484D425F47415343"; //AES Key
