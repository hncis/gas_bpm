package com.hncis.generalService.vo;

import com.hncis.common.vo.Common;

public class BgabGascgsDto extends Common {
	private String year = "";
	...
	public String getSeqc_nm() {
		return seqc_nm;
	}
	public void setSeqc_nm(String seqc_nm) {
		this.seqc_nm = seqc_nm;
	}
